					...
					<Popover.Panel focus className="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"								>
						<div className="rounded-lg shadow-md bg-white dark:bg-slate-900 ring-1 ring-black ring-opacity-5 overflow-hidden">
							<div className="px-5 pt-4 flex items-center justify-between">
								<div>
									<img className="h-8 w-auto rounded-full" src={""} alt=""/>
								</div>
								<div className="-mr-2">
							...
							<nav className="bg-white border-gray-200 dark:bg-gray-900 px-2 py-2">
								<div className="items-center justify-between w-full flex" id="mobile-menu-2">
							...
							<button className={`block w-full px-5 py-3 text-center font-medium text-red-600 text-indigo-6000 bg-gray-50 hover:bg-gray-100`}>
								Log out
							</button>
						</div>
					</Popover.Panel>
			...
			<section className="bg-gray-50 dark:bg-gray-800">
				<div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
					<div className="max-w-screen-sm mx-auto text-center">
						<h2 className="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Suscribe to our free newsletter today</h2>
						<p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Stay informed about our activities; anywhere, anytime.</p>
						<div className="flex justify-center items-center">
							<input type="email" placeholder="example@email.com" className="max-w-sm w-full py-2.5 focus:ring-1 focus:ring-purple-300 font-medium rounded-l-lg text-sm px-5 focus:outline-none dark:focus:ring-purple-800"/>
							<a href="#" className="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-r-lg text-sm px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Suscribe</a>
						</div>
					</div>
				</div>
			</section>
				...
				<div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
					...
					<div className="text-center">
						<a href="#" className="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
							<img src="./images/logo.svg" className="h-6 mr-3 sm:h-9" alt="CITAD Logo" />
							CITAD    
						</a>
						<span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 VuetifySolutions™. All Rights Reserved. Built with <a href="https://flowbite.com" className="text-purple-600 hover:underline dark:text-purple-500">Next.js</a> and <a href="https://tailwindcss.com" className="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a>.
						</span>
